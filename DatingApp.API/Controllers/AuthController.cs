...
namespace DatingApp.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        {
            User userFromRepo = await _repository.Login(userForLoginDto.Username.ToLower(), userForLoginDto.Password);
            ...
            return Ok(new {
                securityToken = tokenHandler.WriteToken(securityToken)
            });
        }
    }
}